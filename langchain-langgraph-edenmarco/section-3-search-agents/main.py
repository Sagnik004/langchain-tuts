...
# Define the llm, and provide it the Pydantic Agent Response format
...
# Output parser using Pydantic model --> moved away to .with_structured_output()
...
# Agent runtime, extract the output coming from agent executor
...
def main():
    result = chain.invoke(
        input={
            "input": "Search for 3 active job postings for an AI engineer using LangChain in Bangalore India on LinkedIn and list their details",
        }
    )
    print(result)
