...
def implement_compare_models(prompt):
    ...
    """
    # TODO: Your implementation here
    model4_result = implement_query_model(implement_llama_4_model(), prompt)
    model33_result = implement_query_model(implement_llama_3_3_model(), prompt)
    return {
        "llama-4-8b-instant": model4_result, 
        "llama-3.3-70b-versatile": model33_result
    }
