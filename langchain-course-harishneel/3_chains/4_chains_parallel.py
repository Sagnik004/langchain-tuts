# Reference: https://youtu.be/_rbIuaup8gE?list=PLNIQLFWpQMRU1Ayjc-LX2k01Jj7uDG0rU
...
plot_branch_chain = (
  RunnableLambda(lambda x: analyze_plot(x)) | llm_model | StrOutputParser()
)

character_branch_chain = (
  RunnableLambda(lambda x: analyze_characters(x)) | llm_model | StrOutputParser()
)
...
# Run the chain
output = chain.invoke({"movie_name": "Inception"})
